...
data class RepoDto(
    ...
    @SerializedName("owner") var ownerDto: OwnerDto,
    ...
    @SerializedName("license") var license: LicenseDto?,
    @SerializedName("allow_forking") var allowForking: Boolean,
    @SerializedName("is_template") var isTemplate: Boolean,
    @SerializedName("web_commit_signoff_required") var webCommitSignOffRequired: Boolean,
    ...
    @SerializedName("permissions") var permissionsDto: PermissionsDto
